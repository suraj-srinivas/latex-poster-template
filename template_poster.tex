...
{\begin{minipage}{\textwidth}
  ...
  \centering
    ...
    {\\\footnotesize{Main Image Highlighting the method}}
    \label{fig:figure1}
  \end{minipage}}
...
\begin{itemize}
  \item Mention key takeaways in this box.
  \item Add graphics / graphs / plots generously. Avoid filling the poster with dense text and equations.
  \item Have fun with the design!
\end{itemize} 
